                                        ...
                                        @foreach ($pembayaran as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('admin.pembayaran.delete', $item->id) }}"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    value="{{ old('nama') }}" name="nama" placeholder="Masukan Nama Pembayaran" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('harga') is-invalid @enderror"
                                    value="{{ old('harga') }}" name="harga" placeholder="Masukan Harga Pembayaran" required>
                                <div class="invalid-feedback">
                                    Masukan Harga Pembayaran
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '#edit', function() {
                ...
                $('#form-edit').attr('action','/admin/pembayaran/update/' + id);
            });
        });
    </script>
    <script>
